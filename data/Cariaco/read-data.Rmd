...
```{r}
fn <- here::here("data/Cariaco/phytoplankton.txt")
...
fn <- here::here("data/Cariaco/zooplankton.txt")
h <- readLines(fn, n = 1)
col_names_v <- str_squish(h) |> str_split(" ")
...
```{r}
fn <- here::here("data/Cariaco/niskin.txt")
h <- readLines(fn, n = 1)
col_names_v <- str_squish(h) |> str_split(" ")
...
niskin_ss <- niskin |> rename(Cruise_ID = Cruise_ID_2, depth = Depth_target) |>
  ...
  select(Cruise_ID, depth, 
         ...
         Chlorophyll)
write_csv(phyto_ss, here::here("data/Cariaco/phyto-ss.csv"))
write_csv(zoo_ss, here::here("data/Cariaco/zoo-ss.csv"))
write_csv(niskin_ss, here::here("data/Cariaco/niskin-ss.csv"))
